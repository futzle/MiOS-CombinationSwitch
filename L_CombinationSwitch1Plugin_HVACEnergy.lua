module ("L_CombinationSwitch1Plugin_HVACEnergy", package.seeall)

local MAIN

local HVAC_SERVICE_ID = "urn:upnp-org:serviceId:HVAC_UserOperatingMode1"
local HVAC_VARIABLE_MODE = "EnergyModeStatus"
...
function configureState(combinationDeviceId, index)
	...
	local jsMatchMode = MAIN.jsSetupState("matchMode", combinationDeviceId, MAIN.pluginId, index .. INDEX_SWITCH_MODE, [["Normal"]])
