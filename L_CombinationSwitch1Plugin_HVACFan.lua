module ("L_CombinationSwitch1Plugin_HVACFan", package.seeall)

local MAIN

local HVAC_SERVICE_ID = "urn:upnp-org:serviceId:HVAC_FanOperatingMode1"
local HVAC_VARIABLE_MODE = "Mode"
...
function configureState(combinationDeviceId, index)
	...
	local jsMatchMode = MAIN.jsSetupState("matchMode", combinationDeviceId, MAIN.pluginId, index .. INDEX_SWITCH_MODE, [["ContinuousOn"]])
